...
<nav>
<ul>
<li><a href="signupp.php"  style="color: #99ffcc; font-family: 'Lucida Calligraphy', sans-serif;font-size: 18px;">SignUp</a></li></ul>
</nav>
<div  style="color: #99ffcc; font-family: 'Lucida Calligraphy', sans-serif;font-size: 22px;">
	<center><h1>Please Sign In here..!!!</h1></center>
	<form action="logemail.php" method="post" name="form" type="text/plain">
